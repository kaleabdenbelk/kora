...
var PlanService = /** @class */ (function () {
    ...
    PlanService.prototype.generatePlan = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var profile, existingPlan, selection, program;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.default.onboarding.findUnique({
                            where: { userId: userId },
                        })];
                    case 1:
                        profile = _a.sent();
                        ...
                        return [4 /*yield*/, db_1.default.userPlan.findFirst({
                                where: { userId: userId },
                            })];
                    case 2:
                        existingPlan = _a.sent();
                        if (!existingPlan) return [3 /*break*/, 4];
                        console.log("[PlanService] Generating a fresh plan. Deleting previous plan: ".concat(existingPlan.id));
                        return [4 /*yield*/, db_1.default.userPlan.delete({ where: { id: existingPlan.id } })];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, db_1.default.programSelection.findUnique({
                            where: {
                    ...
                    case 5:
                        ...
                        console.log("[PlanService] Program found: ".concat(selection.program.name, ". Creating UserPlan..."));
                        program = selection.program;
                        return [4 /*yield*/, db_1.default.$transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                var startDate, endDate, weeks, jsonCurrentWeek, _i, _a, phase, w, weekNumber, sessions, planJson, userPlan, sessionData, currentWeek, _b, _c, phase, w, weekNumber, _d, _e, workoutTemplate;
                                return __generator(this, function (_f) {
                                    switch (_f.label) {
                                        case 0:
                                            ...
                                            weeks = [];
                                            jsonCurrentWeek = 1;
                                            for (_i = 0, _a = program.phases; _i < _a.length; _i++) {
                                                phase = _a[_i];
                                                for (w = 0; w < phase.durationWeeks; w++) {
                                                    weekNumber = jsonCurrentWeek + w;
                                                    sessions = phase.workouts.map(function (wt) { return ({
                                                        dayNumber: wt.dayNumber,
                                                        name: wt.name,
                                                        rest: false,
                                                        exercises: wt.exercises.map(function (et) { return ({
                                                            id: et.exercise.id,
                                            ...
                                            return [4 /*yield*/, tx.userPlan.create({
                                                    data: {
                                                        userId: userId,
                                        ...
                                        case 1:
                                            ...
                                            sessionData = [];
                                            currentWeek = 1;
                                            for (_b = 0, _c = program.phases; _b < _c.length; _b++) {
                                                phase = _c[_b];
                                                for (w = 0; w < phase.durationWeeks; w++) {
                                                    weekNumber = currentWeek + w;
                                                    for (_d = 0, _e = phase.workouts; _d < _e.length; _d++) {
                                                        ...
                                                        sessionData.push({
                                                            ...
                                                            planned: {
                                                                ...
                                                                exercises: workoutTemplate.exercises.map(function (et) { return ({
                                            ...
                                            return [4 /*yield*/, tx.userSession.createMany({
                                                    data: sessionData,
                                                })];
                                        case 2:
                                            _f.sent();
    ...
    PlanService.prototype.getActivePlan = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("[PlanService] Getting active plan for ".concat(userId, "..."));
                        return [4 /*yield*/, db_1.default.userPlan.findFirst({
                                where: { userId: userId },
